...
To learn how to apply it in your application, check the example [todo-jwt](https://github.com/strongloop/loopback-next/tree/master/examples/todo-jwt) and its tutorial [Apply JWT Authentication in Todo Example](https://loopback.io/doc/en/lb4/Authentication-tutorial.html)
